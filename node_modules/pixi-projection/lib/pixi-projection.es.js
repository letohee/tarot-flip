 ...
 */
import { Geometry, Buffer, AbstractBatchRenderer, BatchShaderGenerator, Renderer, ObjectRenderer, Shader, QuadUv, Program, Filter, TextureMatrix, MaskSystem } from '@pixi/core';
import { TYPES, WRAP_MODES, DRAW_MODES } from '@pixi/constants';
import { premultiplyTint, premultiplyBlendMode, premultiplyTintToRgba, correctBlendMode } from '@pixi/utils';
import { Transform, Point, Rectangle, ObservablePoint, Matrix } from '@pixi/math';
...
var TRANSFORM_STEP; (function (TRANSFORM_STEP) {
...
{constructor(...args) { super(...args); LinearProjection.prototype.__init.call(this);LinearProjection.prototype.__init2.call(this);LinearProjection.prototype.__init3.call(this);LinearProjection.prototype.__init4.call(this);LinearProjection.prototype.__init5.call(this); }
    ...
    __init3() {this._affine = AFFINE.NONE;}
...
class TilingSprite2dRenderer extends ObjectRenderer
{
    constructor(renderer)
    {
        ...
        this.shader = Shader.from(shaderVert$1, shaderFrag$1, uniforms);

        this.simpleShader = Shader.from(shaderVert$1, shaderSimpleFrag, uniforms);
    }

    
    
    __init() {this.quad = new QuadUv();}
...
class Projection2d extends LinearProjection
{
    ...
    __init2() {this.pivot = new ObservablePoint(this.onChange, this, 0, 0);}
...
Renderer.registerPlugin('tilingSprite2d', TilingSprite2dRenderer );
...
class BatchBilineardGeometry extends Geometry
{
...
{constructor(...args) { super(...args); BilinearSurface.prototype.__init.call(this); }
    __init() {this.distortion = new Point();}
...
export { AFFINE, AbstractProjection, Batch2dPluginFactory, Batch3dGeometry, BatchBilinearPluginFactory, BatchBilineardGeometry, BilinearSurface, Camera3d, Container2d, Container3d, Euler, LinearProjection, Matrix2d, Matrix3d, Mesh2d, Mesh3d2d, ObservableEuler, ObservablePoint3d, Point3d, Projection2d, Projection3d, ProjectionSurface, SimpleMesh2d, SimpleMesh3d2d, Sprite2d, Sprite2s, Sprite3d, SpriteMaskFilter2d, Surface, TRANSFORM_STEP, Text2d, Text2s, Text3d, TilingSprite2d, TilingSprite2dRenderer, UniformBatchRenderer, applySpine2dMixin, applySpine3dMixin, container2dToLocal, container2dWorldTransform, container3dGetDepth, container3dIsFrontFace, container3dToLocal, container3dWorldTransform, getIntersectionFactor, getPositionFromQuad, transformHack$1 as transformHack };
//# sourceMappingURL=pixi-projection.es.js.map
